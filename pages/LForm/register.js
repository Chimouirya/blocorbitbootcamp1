						...
						<form onSubmit={handleSubmit(onSubmit)} className="px-8 pt-6 pb-8 mb-4 bg-white rounded">
							...
							<div className="mb-4 md:flex md:justify-between">
								<div className="mb-4 md:mr-2 md:mb-0">
									...
									/>
									<p className="text-xs italic text-red-500">Please use strong password.</p>
								</div>
							...
							<div className="mb-6 text-center">
								<button
								defaultValue="test" {...register("example")}	className="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-full hover:bg-blue-700 focus:outline-none focus:shadow-outline"
									type="submit"
								>
									Register Account
								</button>
